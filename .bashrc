...
function daily {
    TODAY=$(date "+%Y-%m-%d")
    NOTE_PATH="$HOME/grant_work/journal/${TODAY}.md"
...
export PATH=/home/grant/.nimble/bin:$PATH
export PATH=/home/grant/.nimble/bin:$PATH
export PATH=/home/grant/chromaform/install/chroma-qdpxx-double-nd4/bin:$PATH
